...
## Development environment and release process
 ...
 - create virtualenv with Flask and Iceform installed into it (latter is installed in
...
install it (`pip install hseling_api_iceform.tar.gz`), ensure that configuration file exists and
`HSELING_API_ICEFORM_SETTINGS` environment variable points to it, ensure that user has access to the
