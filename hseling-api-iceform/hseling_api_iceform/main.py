...
from hseling_api_iceform import boilerplate

from hseling_lib_iceform.process import process_data
from hseling_lib_iceform.query import query_data


app = Flask(__name__)
app.config['DEBUG'] = False
app.config['LOG_DIR'] = '/tmp/'
if os.environ.get('HSELING_API_ICEFORM_SETTINGS'):
    app.config.from_envvar('HSELING_API_ICEFORM_SETTINGS')
...
if not app.debug:
    ...
    file_handler = TimedRotatingFileHandler(os.path.join(app.config['LOG_DIR'], 'hseling_api_iceform.log'), 'midnight')
